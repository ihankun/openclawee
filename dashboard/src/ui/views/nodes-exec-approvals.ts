...
function approvalOptionLabel(value: ExecSecurity | ExecAsk): string {
  switch (value) {
    case "deny":
      return t("nodes.execApprovals.options.deny");
    case "allowlist":
      return t("nodes.execApprovals.options.allowlist");
    case "full":
      return t("nodes.execApprovals.options.full");
    case "off":
      return t("nodes.execApprovals.options.off");
    case "on-miss":
      return t("nodes.execApprovals.options.onMiss");
    case "always":
      return t("nodes.execApprovals.options.always");
  }
}
  ...
  return html`
    <div class="list" style="margin-top: 12px;">
      ...
      ${state.target === "node" && !hasNodes
        ? html` <div class="muted">${t("nodes.execApprovals.noApprovalNodes")}</div> `
        : nothing}
    </div>
  `;
}
    ...
    <div class="list" style="margin-top: 16px;">
          ...
          <div class="list-sub">
            ${isDefaults
              ...
              : t("nodes.execApprovals.defaultValue", {
                  value: approvalOptionLabel(defaults.security),
                })}
          </div>
        </div>
        <div class="list-meta">
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults
              ? t("nodes.execApprovals.defaultPromptPolicy")
              : t("nodes.execApprovals.defaultValue", {
                  value: approvalOptionLabel(defaults.ask),
                })}
          </div>
        </div>
        <div class="list-meta">
      ...
      <div class="list-item">
        <div class="list-main">
          ...
          <div class="list-sub">
            ${isDefaults
              ? t("nodes.execApprovals.fallbackUnavailable")
              : t("nodes.execApprovals.defaultValue", {
                  value: approvalOptionLabel(defaults.askFallback),
                })}
          </div>
        </div>
        <div class="list-meta">
      ...
      <div class="list-item">
        <div class="list-main">
          <div class="list-title">${t("nodes.execApprovals.autoAllowSkillClis")}</div>
          <div class="list-sub">
            ${isDefaults
              ? t("nodes.execApprovals.autoAllowSkillClisHint")
              : autoIsDefault
                ? t("nodes.execApprovals.usingDefault", {
                    state: defaults.autoAllowSkills
                      ? t("nodes.execApprovals.on")
                      : t("nodes.execApprovals.off"),
                  })
                : t("nodes.execApprovals.overrideState", {
                    state: autoEffective
                      ? t("nodes.execApprovals.on")
                      : t("nodes.execApprovals.off"),
                  })}
...
function renderExecApprovalsAllowlist(state: ExecApprovalsState) {
  ...
  return html`
    ...
    <div class="list" style="margin-top: 12px;">
      ${entries.length === 0
        ? html` <div class="muted">${t("nodes.execApprovals.noEntries")}</div> `
